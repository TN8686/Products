...
namespace Engine {
	...
	class Liner4TreeManager {
		...
		bool combinationList_[OFTLAYER_NUM * (OFTLAYER_NUM + 1) / 2] = {
	...
	protected:
		...
		Float2 widthHight_;									// 領域の幅と高さ.
		Float2 topLeft_;									// 領域の基準点 左上.
		Float2 unitWidthHight_;								// 最小レベル空間の幅と高さ.
		DWORD cellNum_;										// 空間の数.
	...
	public:
		...
		// オブジェクトを登録する.
		// TODO 領域外の値が来た時を考慮していない.
		// 片方の点が領域内ならもう片方を端っこに補正する？.
